...
namespace parola
{
    public class Selenium
    {
        ...
        public IWebDriver Gmail(string kullaniciadi, string parola)
        {
            tryCatchBlock(() =>
            {
                string GirisSayfasiAdres = "https://accounts.google.com/AccountChooser?service=mail&continue=https://mail.google.com/mail/";
        ...
        public IWebDriver GarantiBank(string kullaniciadi, string parola)
        {
            tryCatchBlock(() =>
            {
                driver.Navigate().GoToUrl("https://sube.garantibbva.com.tr/isube/login/login/passwordentrypersonal-tr");
        ...
        public IWebDriver Turknet(string kullaniciadi, string parola_)
        {
            tryCatchBlock(() =>
            {
                driver.Url = "https://turk.net/online-islemler/login";
                driver.Manage().Window.Maximize();
                Stop();
                driver.FindElement(By.Id("input-username")).SendKeys(kullaniciadi);
                driver.FindElement(By.Id("input-password")).SendKeys(parola_);
                // butona manual tıklanacak
            });
            return driver;
        }
        public IWebDriver MakbuzSistemi(string kullaniciadi, string parola_)
        {
            tryCatchBlock(() =>
            {
                driver.Url = "http://88.249.252.52/Account/login.aspx";
                driver.Manage().Window.Maximize();
                driver.FindElement(By.Id("ctl00_ctl00_MainPane_Content_MainContent_tbUserName_I")).SendKeys(kullaniciadi);
                driver.FindElement(By.Id("ctl00_ctl00_MainPane_Content_MainContent_tbPassword_I")).SendKeys(parola_);
                Stop();
                driver.FindElement(By.Id("ctl00_ctl00_MainPane_Content_MainContent_btnLogin_CD")).Click();
            });
            return driver;
        }
